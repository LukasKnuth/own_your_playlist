...
#
#     PHX_SERVER=true bin/own_your_playlist start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :own_your_playlist, OwnYourPlaylistWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :own_your_playlist, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
